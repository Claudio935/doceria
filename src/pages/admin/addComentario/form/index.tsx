...
interface AddCommentFunctionProps extends commentData {

    image: File | null
}
interface PropsFormComment {
    addCommentFunction: (data: AddCommentFunctionProps) => void
}

const FormComment: React.FC<PropsFormComment> = ({ addCommentFunction }) => {
    ...
    const onSubmit: SubmitHandler<commentData> = async (comment) => {
        ...
        addCommentFunction({ ...comment, image: image ? image : null })
